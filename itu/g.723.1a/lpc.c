 ...
 */
  ...
  */
            ...
            /* Update memory */
            CodStat->WghtIirDl[0] = g723_round( Acc0 ) ;
...
*PrevErr )
{
  ...
  */
        ...
        Dpnt[i] = shl( g723_round( Acc1 ), (Word16) 1 ) ;
  ...
  */
        ...
        CodStat->RingFirDl[0] = g723_round( Acc1 ) ;
        ...
        CodStat->RingIirDl[0] = g723_round( Acc0 ) ;
...
void     Synt( Word16 *Dpnt, Word16 *Lpc )
{
  ...
  */
        ...
        DecStat->SyntIirDl[0] = g723_round( Acc0 ) ;
...
Word32  Spf( Word16 *Tv, Word16 *Lpc )
{
  ...
  */
        ...
        DecStat->PostIirDl[0] = g723_round( Acc0 ) ;
